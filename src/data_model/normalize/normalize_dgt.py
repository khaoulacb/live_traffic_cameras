...
class NormalizeDgt(NormalizeSource):

    def __init__(self):
       NormalizeSource.__init__(self, "dgt")
    ...
    def getNormalizedDataframe(self):
        ...
        if data is None:
            ...
            try:
                fields = ["id", "imagen", "carretera", "pk", "latitud", "longitud"]
                df = data[fields]
                df.rename(columns = {"id": "camera_id", "imagen": "url_image", "carretera": "road", "pk": "km", "longitud": "longitude", "latitud": "latitude"}, inplace=True)
